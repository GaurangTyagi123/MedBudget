    ...
    if (patientName.length)
        ...
        return (
            <div className=' h-[60vh] flex flex-col items-center justify-evenly gap-y-5'>
                ...
                <Link href={"/"} className='text-md bg-mb-primary-500 px-5 py-2 text-white capitalize font-extralight rounded-md shadow-2xl shadow-mb-primary-200 transition-transform hover:translate-y-0.5'>Go Back</Link>
            </div>
        )
}
