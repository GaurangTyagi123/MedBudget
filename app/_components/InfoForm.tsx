    ...
    <>
      <div className="space-y-5 relative">
        ...
        >
            ...
            <div className="flex flex-col items-center justify-between gap-y-2 w-lg h-20">
              <input
                ...
                {...register('medicineName', {
                  ...
                  required: 'Please enter a name for the medicine',
                  validate: (value) => {
                    return (
            ...
            <div className="flex flex-col items-center justify-between gap-y-2 w-lg h-20">
              <input
                ...
                {...register('medicinePrice', {
                  valueAsNumber: true,
                  required: 'Please enter price for the medicine',
                  min: {
                    value: 1,
          ...
          {Array.from({ length: numOfFields }, (_, i) => i).map((index) => {
            return (
              <div
                className="w-screen flex items-center justify-evenly  gap-x-4"
                key={index + 1}
                data-testid="additional_fields"
              >
                <div className="flex flex-col items-center justify-between gap-y-2 w-lg h-20">
                  <input
                    autoComplete="off"
                  ...
                  />
                  {errors[`medicineName-${index + 1}`]?.message && (
                    <span className="text-red-500 font-bold text-xs uppercase">
                      {String(errors[`medicineName-${index + 1}`]?.message)}
                    </span>
                  )}
                </div>
                <div className="flex flex-col items-center justify-between gap-y-2 w-lg h-20">
                  <input
                    ...
                    className="form_input"
                    required
                    {...register(`medicinePrice-${index + 1}`, {
                      valueAsNumber: true,
                      required: 'Please enter price for the medicine',
                      min: {
                        value: 1,
                  ...
                  {errors?.[`medicineName-${index + 1}`]?.message && (
                    <span className="text-red-500 font-bold text-xs uppercase">
                      {String(errors?.[`medicinePrice-${index + 1}`]?.message)}
                    </span>
                  )}
                </div>
                <div className="flex flex-col items-center justify-between gap-y-2 w-lg h-20">
                  <input
                    ...
                    className="form_input"
                    required
                    {...register(`quantityPerPack-${index + 1}`, {
                      valueAsNumber: true,
                      required: 'Please enter quantity per pack',
                      min: {
                        value: 1,
                  ...
                  />
                  {errors?.[`quantityPerPack-${index + 1}`]?.message && (
                    <span className="text-red-500 font-bold text-xs uppercase">
                      {String(
                        errors?.[`quantityPerPack-${index + 1}`]?.message,
                      )}
                ...
                <div className="flex flex-col items-center justify-between gap-y-2 w-lg h-20">
                  <input
                    ...
                    required
                    {...register(`quantityPerDose-${index + 1}`, {
                      valueAsNumber: true,
                      required: 'Please enter dose taken per day',
                      min: {
                        value: 1,
                  ...
                  />
                  {errors?.[`quantityPerDose-${index + 1}`]?.message && (
                    <span className="text-red-500 font-bold uppercase text-xs">
                      {String(
                        errors?.[`quantityPerDose-${index + 1}`]?.message,
                      )}
